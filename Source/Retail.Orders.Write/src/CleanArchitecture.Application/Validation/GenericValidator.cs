...
namespace Retail.Orders.Write.src.CleanArchitecture.Application.Validation
{
    ...
    public static class GenericValidator
    {
        ...
        /// <summary>
        /// Validates if a numeric value is less than or equal to zero.
        /// </summary>
        ...
        /// <param name="validationData">The result of the validation.</param>
        /// <param name="failureSeverity">The severity level of the validation if it fails.</param>
        /// <returns>True if the value is less than or equal to zero, false otherwise.</returns>
        public static bool IsLessThanOrEqualToZero<T>(T value, string validatorName, string fieldName, out ValidationData validationData, FailureSeverity failureSeverity = FailureSeverity.Error) where T : IComparable<int>
        {
            if (value.CompareTo(0) <= 0)
            {
                validationData = new ValidationData(
                    validatorName: validatorName,
                    failureReason: $"The {fieldName} field must be greater than zero.",
                    failureSeverity: failureSeverity);
                return true;
            }
